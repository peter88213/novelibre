[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.6.2.pyzw)
...
Download the latest release [novelibre_v4.6.2.pyzw](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.6.2.pyzw)

- Launch *novelibre_v4.6.2.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python novelibre_v4.6.2.pyzw` (Windows), resp. `python3 novelibre_v4.6.2.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [novelibre_v4.6.2.zip](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.6.2.zip)

- Extract the *novelibre_v4.6.2* folder from the downloaded zipfile "novelibre_v4.6.2.zip".
