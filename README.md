[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.8.1.pyzw)
...
Download the latest release [novelibre_v4.8.1.pyzw](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.8.1.pyzw)

- Launch *novelibre_v4.8.1.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python novelibre_v4.8.1.pyzw` (Windows), resp. `python3 novelibre_v4.8.1.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [novelibre_v4.8.1.zip](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v4.8.1.zip)

- Extract the *novelibre_v4.8.1* folder from the downloaded zipfile "novelibre_v4.8.1.zip".
