[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v5.0.10.pyzw)
...
Download the latest release [novelibre_v5.0.10.pyzw](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v5.0.10.pyzw)

- Launch *novelibre_v5.0.10.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python novelibre_v5.0.10.pyzw` (Windows), resp. `python3 novelibre_v5.0.10.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [novelibre_v5.0.10.zip](https://github.com/peter88213/novelibre/raw/main/dist/novelibre_v5.0.10.zip)

- Extract the *novelibre_v5.0.10* folder from the downloaded zipfile "novelibre_v5.0.10.zip".
