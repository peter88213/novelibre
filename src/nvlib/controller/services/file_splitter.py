...
class FileSplitter(ServiceBase):
    ...
    def split_project(self):
        ...
        newNovel = Novel(
            ...
            noScnField1=sourceNovel.noScnField1,
            noScnField2=sourceNovel.noScnField2,
            noScnField3=sourceNovel.noScnField3,
            ...
            chrExtraField1=sourceNovel.chrExtraField1,
            chrExtraField2=sourceNovel.chrExtraField2,
