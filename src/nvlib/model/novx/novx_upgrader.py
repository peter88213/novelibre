...
class NovxUpgrader:
    ...
    def _upgrade_to_1_11(cls, xmlRoot):
        ...
        for xmlSection in xmlRoot.iter(tag='SECTION'):
            ...
            if not re.search(r'<p s', xmlStr):
                # the section doesn't contain any paragraphs with style attributes
                continue
...
class Converter1_11(sax.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        # Remove paragraph style attributes and change tag.
        attributes = []
        ...
        self._xmlLines.append(f'<{name}{"".join(attributes)}>')
        self._tags.append(name)
