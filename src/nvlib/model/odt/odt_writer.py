...
class OdtWriter(OdfFile):
    ...
    _NOVELIBRE_STYLES = (
        ...
        '  </style:style>\n'
        f'  <style:style style:name="{_("Epigraph")}" style:display-name="{_("Epigraph")}" style:family="paragraph" style:parent-style-name="Quotations" style:next-style-name="{_("Epigraph source")}" style:class="text">\n'
        '  </style:style>\n'
        f'  <style:style style:name="{_("Epigraph_20_source")}" style:display-name="{_("Epigraph source")}" style:family="paragraph" style:parent-style-name="{_("Epigraph")}" style:next-style-name="Text_20_body" style:class="text">\n'
        '  <style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="1.46cm"/>\n'
        '  <style:text-properties fo:font-style="italic"/>\n'
        '  </style:style>\n'
        f'  <style:style style:name="{_("Section_20_mark")}" style:display-name="{_("Section mark")}" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Text_20_body" style:class="text">\n'
        '   <style:text-properties fo:color="#008000" fo:font-size="10pt" fo:language="zxx" fo:country="none"/>\n'
        '  </style:style>\n'
        f'  <style:style style:name="{_("Heading_20_3_20_invisible")}" style:display-name="{_("Heading 3 invisible")}" style:family="paragraph" style:parent-style-name="Heading_20_3" style:class="text">\n'
