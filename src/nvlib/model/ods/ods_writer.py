...
class OdsWriter(OdfFile):
    ...
    _SETTINGS_XML = (
        ...
        'config:type="int">44972</config:config-item>\n'
        '   <config:config-item config:name="VisibleAreaHeight" '
        'config:type="int">18999</config:config-item>\n'
        ...
        'config:type="string">$Language</config:config-item>\n'
        '     <config:config-item config:name="Country" '
        'config:type="string">$Country</config:config-item>\n'
