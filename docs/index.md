...
[Download the latest release (version 1.2.0)](https://github.com/peter88213/noveltree/raw/main/dist/noveltree_v1.2.0.zip)

- Extract the "noveltree_v1.2.0" folder from the downloaded zipfile "noveltree_v1.2.0.zip".
