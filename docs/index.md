...
[Download the latest release (version 1.7.2)](https://github.com/peter88213/noveltree/raw/main/dist/noveltree_v1.7.2.zip)

- Extract the "noveltree_v1.7.2" folder from the downloaded zipfile "noveltree_v1.7.2.zip".
