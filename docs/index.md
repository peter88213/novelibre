...
[Download the latest release (version 1.6.6)](https://github.com/peter88213/noveltree/raw/main/dist/noveltree_v1.6.6.zip)

- Extract the "noveltree_v1.6.6" folder from the downloaded zipfile "noveltree_v1.6.6.zip".
