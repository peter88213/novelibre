...
[Download the latest release (version 1.6.3)](https://github.com/peter88213/noveltree/raw/main/dist/noveltree_v1.6.3.zip)

- Extract the "noveltree_v1.6.3" folder from the downloaded zipfile "noveltree_v1.6.3.zip".
