...
[Download the latest release (version 1.6.9)](https://github.com/peter88213/noveltree/raw/main/dist/noveltree_v1.6.9.zip)

- Extract the "noveltree_v1.6.9" folder from the downloaded zipfile "noveltree_v1.6.9.zip".
